...
<img src="{{ site.s_host }}/hs-airdrop/1.png"  width="640" height="auto">
...
<img src="{{ site.s_host }}/hs-airdrop/2.png"  width="640" height="auto">

将它贴到「空投页面」第五步提交，如图：

<img src="{{ site.s_host }}/hs-airdrop/3.png"  width="640" height="auto">

提示成功：

<img src="{{ site.s_host }}/hs-airdrop/4.png"  width="640" height="auto">

然后提示成功，打开 https://www.namebase.io/dashboard 会显示有进行中的交易，16 个小时左右到帐。

<img src="{{ site.s_host }}/hs-airdrop/7.png"  width="640" height="auto">
